...
var authConfigEndpointRequest = function (req, res, next) {
...
app.get('/register/:clientId', authConfigEndpointRequest, function (req, res) {
  res.status(200).json(req.client)
})

app.put('/register/:clientId', authConfigEndpointRequest, function (req, res) {
...
app.delete('/register/:clientId', authConfigEndpointRequest, function (req, res) {
  const client = req.client
